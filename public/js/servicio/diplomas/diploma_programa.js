$(document).ready(function () {
    ...
    window.enviarDatos = function(fondoSiNo) {
        ...
        window.document.getElementById('nombre-programa').setAttribute('class', 'form-control ');

        // Validaciones de los datos
        var noValido= false;
        if(!validarNoNulo(document.getElementById('nombre-programa').value,'nombre-programa')){
            noValido=true;
        }
        if(noValido){
            return;
        ...
        //Obtner nombre curso
        var e1 = document.getElementById("nombre-programa");
        var nombrePrograma = e1.options[e1.selectedIndex].value;
        //Obtener tipo fondo
        ...
        $.ajax({
            ...
            type: "POST",
            url: "/servicio/diploma_programa_generar",
            data: {
                participantes: participantes,
                fecha: fecha,
                nombre_programa_curso: nombrePrograma,
