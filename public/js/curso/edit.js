$(document).ready(function () {
    ...
    $('#cant_participantes').keyup(function() {
        var cantHoras = document.getElementById('cant_participantes');
        var numeroCantHoras = cantHoras.value;
        cantHoras.value = formatoNumeroInput(numeroCantHoras);
    });
    ...
    window.enviarDatos = function(id) {
        ...
        $.ajax({
            ...
            data:
                ...
                cant_participantes:  quitarFormatoDecimal($('#cant_participantes').val()),
            ...
            success: function(result) {
                // console.log('ajax ok');
                window.location.replace("/curso/show/"+id);
            },
            error: function(xhr) {
                var error = '';
    ...
    if(document.getElementById('nombre_sence').value==""){
        senceReadOnly=true;
    }else{
        $("#opcion_sence").prop('checked',true);
        senceReadOnly=false;
    }
    document.getElementById("opcion_sence").checked = !senceReadOnly;
    document.getElementById("nombre_sence").readOnly = senceReadOnly;
    document.getElementById("codigo_sence").readOnly = senceReadOnly;
    document.getElementById("vigencia").readOnly = senceReadOnly;
    // darle formato a los numeros traidos de la bd
    document.getElementById('cant_horas_practicas').value = formatoNumeroShow(quitarFormatoDecimal(document.getElementById('cant_horas_practicas').value.replace(/\./g, ',')));
    document.getElementById('cant_horas_teoricas').value = formatoNumeroShow(quitarFormatoDecimal(document.getElementById('cant_horas_teoricas').value.replace(/\./g, ',')));
    document.getElementById('cant_horas').value = formatoNumeroShow(quitarFormatoDecimal(document.getElementById('cant_horas').value.replace(/\./g, ',')));
    document.getElementById('cant_participantes').value = formatoNumeroShow(quitarFormatoNumero(document.getElementById('cant_participantes').value));
});