$(document).ready(function () {
    ...
    $('#cargo').change(function() {
        window.document.getElementById('cargo').setAttribute('class', 'form-control');
    });
    ...
    function validarDatos() {
        ...
        if(!validarNoNulo(document.getElementById('cargo').value,'cargo')){
            valido = false;
        }
    ...
    /**
     * Envia los datos del contacto empresa
     */
    window.enviarDatos = function(id) {
        ...
        // var respuesta = confirm("¿Está seguro que los datos del Contacto de la Empresa están correctos?");
        // if(respuesta==false){
        //     return;
        // }
        $.ajax({
            ...
            type: "POST",
            url: "/contacto_empresa/update/"+id,
            data: {
                nombre: $('#nombre').val(),
                apellido: $('#apellido').val(),
                mail: $('#mail').val(),
                direccion: $('#direccion').val(),
                empresa: selectizeControl.getValue(),
            ...
            success: function(result) {
                // console.log('ajax ok');
                window.location.replace("/contacto_empresa/show/"+id);
            },
            error: function(xhr) {
                var error = '';
                // console.log(xhr);
    ...
    // Arreglo con los datos de la empresa
