    ...
    <div class="card col-lg-12 col-md-12 mx-auto">
        <div class="card-header">
            <div class="col-md-12 col-sm-12">
                <h3 class="card-title">Generar diplomas para el programa: {{$programa->nombre}}, impartido {{$fecha}}</h3>
            </div>
        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select class="form-control" id="nombre-programa">
...
@section('scripts')
            ...
            <script src="/js/servicio/diplomas/diploma_programa.js"></script>
@endsection
