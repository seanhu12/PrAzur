    ...
    <div class="card  col-lg-8 col-md-12 mx-auto">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="nombre_venta" type="text" class="form-control" name="nombre_venta" placeholder="Nombre" maxlength="191" autofocus >
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea id="descripcion" type="text" class="form-control" name="telefono_fijo" placeholder="Descripción" maxlength="9999" ></textarea>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="cant_horas_practicas" onchange="validarMaxDosDigitosDecimal('cant_horas_practicas');" type="text" class="form-control" name="cant_horas_practicas" placeholder="0"  maxlength="11" >
                        <div id="cant_horas_practicas-alert" class="invalid-feedback">La cantidad de horas práticas no es válida. Debe ser un número entero positivo.</div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        <label class="form-label">Año de Creación*</label>
                        <input id="anio_creacion" onchange="validarAnioPasado(document.getElementById('anio_creacion').value,'anio_creacion');" type="text" class="form-control" name="anio_creacion" placeholder="0" max="9999" min="1990" >
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="cant_participantes" onchange="validarMaxDosDigitos('cant_participantes');" type="text" class="form-control" name="cant_participantes" placeholder="0" maxlength="11" >
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="cant_horas_teoricas" onchange="validarMaxDosDigitosDecimal('cant_horas_teoricas');" type="text" class="form-control" name="cant_horas_teoricas" placeholder="0" maxlength="11" >
                        <div id="cant_horas_teoricas-alert" class="invalid-feedback">La cantidad de horas teóricas no es válida. Debe ser un número entero positivo.</div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="cant_horas" type="text" class="form-control" name="cant_horas" placeholder="0"  maxlength="11"  readonly>
            ...
            <div class="row">
                <div class="col-md-8 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="nombre_sence" type="text" class="form-control" name="nombre_sence" placeholder="Nombre" maxlength="191" readonly>
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="codigo_sence" onchange="validarNumero(document.getElementById('codigo_sence').value,'codigo_sence');" type="text" class="form-control" name="codigo" placeholder="Código" max="999999999" min="0" readonly>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="vigencia" onchange="validarFechaNoPasada(document.getElementById('vigencia').value,'vigencia');" type="date" class="form-control" name="vigencia" placeholder="Fecha fin vigencia"  readonly>
        ...
        <div class="card-footer row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <button type="button" onclick="enviarDatos();" id="button-crear" class="btn btn-primary" >Crear Curso</button>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="/js/curso/create.js"></script>
@endsection
