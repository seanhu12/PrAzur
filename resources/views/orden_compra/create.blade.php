...
@section('titulo', 'Crear Orden de Compra')
    @section('contenido')

        <div class="card  col-lg-6 col-md-6 mx-auto">
            <div class="card-header">
                <h3 class="card-title">Crear Orden de Compra para el Servicio {{$servicio->nombre}}</h3>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="numero" onchange="validarNumero(document.getElementById('numero').value,'numero');" type="text" class="form-control" name="numero" placeholder="numero" maxlength="9" autofocus >
            ...
            <div class="card-footer row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                        <button type="button" onclick="enviarDatos({{$servicio->id}});" id="button-crear" class="btn btn-primary" >Crear Orden de Compra</button>
                </div>
            </div>
        </div>
    ...
    @section('scripts')
        ...
        <script src="/js/orden_compra/create.js"></script>
    @endsection
