    ...
    <div class="card  col-lg-8 col-md-12 mx-auto">
            ...
            <div class="row">
                <div class="col-md-8 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="nombre" type="text" class="form-control" name="nombre" value="{{$empresa->nombre}}" placeholder="Nombre" maxlength="191" autofocus >
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="rut" onchange="validarRut(document.getElementById('rut').value);" type="text" class="form-control" name="rut" value="{{$empresa->rut}}" placeholder="RUT" maxlength="191"  readonly>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="mail" onchange="validarEmail(document.getElementById('mail').value,'mail');" type="text" class="form-control" name="mail" value="{{$empresa->mail}}" placeholder="Correo Electrónico" maxlength="191" >
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="direccion" type="text" class="form-control" name="direccion" value="{{$empresa->direccion}}" placeholder="Nombre Calle/Pasaje y número" maxlength="191" >
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="telefono_fijo" onchange="validarTelefonoFijo(document.getElementById('telefono_fijo').value,'telefono_fijo');" type="text" class="form-control" name="telefono_fijo" value="{{$empresa->telefono_fijo}}" placeholder="000 000 0000" maxlength="191" >
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="celular" onchange="validarCelular(document.getElementById('celular').value,'celular');" type="text" class="form-control" name="celular" value="{{$empresa->celular}}" placeholder="+000 0000 0000" maxlength="191">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <div id="data-tag-empresa" data-data='{{$empresa->holding_id}}'></div>
        ...
        <div class="card-footer row">
            <div class="col-md-6 col-sm-12">
                <a href="/empresa/show/{{$empresa->id}}" class="btn btn-secondary">Cancelar</a>
            </div>
            <div class="col-md-6 col-sm-12 text-right">
                <button type="button" onclick="enviarDatos({{$empresa->id}});" id="button-crear" class="btn btn-primary" >Guardar Cambios</button>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="/js/empresa/edit.js"></script>
@endsection
