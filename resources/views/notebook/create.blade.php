...
@section('titulo', 'Crear Notebook')
    @section('contenido')

        <div class="card  col-lg-8 col-md-12 mx-auto">
            <div class="card-header">
                <h3 class="card-title">Crear Notebook</h3>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="marca" type="text" class="form-control" name="marca" placeholder="Marca" maxlength="191"  >
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="custom_file_notebook" name="custom_file_notebook"  >
            ...
            <div class="card-footer row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <button type="button" onclick="enviarDatos();" id="button-crear" class="btn btn-primary" >Crear Notebook</button>
                </div>
            </div>
        </div>
    ...
    @section('scripts')
        ...
        <script src="/js/notebook/create.js"></script>
        <script src="/js/notebook/create_file.js"></script>
    @endsection
