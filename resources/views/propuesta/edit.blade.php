...
@section('titulo', 'Modificar Propuesta')
@section('contenido')
    ...
    <div class="card col-lg-12 col-md-12 mx-auto">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="fecha_propuesta" onchange="validarFechaNoFutura(document.getElementById('fecha_propuesta').value,'fecha_propuesta');" type="date" class="form-control" name="fecha_propuesta" value="{{$propuesta->fecha_propuesta}}" placeholder="Fecha Propuesta" autofocus readonly disabled>
                                <div id="fecha_propuesta-alert" class="invalid-feedback">La fecha ingresada no puede ser futura.</div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Fecha Compromiso*</label>
                                <input id="fecha_compromiso" onchange="validarFechaNoPasada(document.getElementById('fecha_compromiso').value,'fecha_compromiso');" type="date" class="form-control" name="fecha_compromiso" value="{{$propuesta->fecha_compromiso}}" placeholder="Fecha Compromiso">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cant_total_horas" onchange="calcularMonto();validarMaxMinNumeroHoras();" type="text" class="form-control" value="{{$propuesta->cant_total_horas}}" placeholder="Cantidad Total Horas" maxlength="11">
                            ...
                            <div class="form-group">
                                ...
                                <input id="uf_hora" onchange="calcularMonto();validarValorHora();" type="text" class="form-control" value="{{$propuesta->uf_hora}}" placeholder="Valor Hora" maxlength="13">
                                <div id="uf_hora-alert" class="invalid-feedback">Se debe ingresar un valor entre 0 y 999.999.</div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Monto</label>
                                <input id="monto" type="text" class="form-control" name="monto" value="{{$propuesta->monto}}" placeholder="Monto" readonly>
                                <div id="monto-alert" class="invalid-feedback">Se debe ingresar un número.</div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <div id="data-tag-area" data-data='{{$areasJson}}'></div>
                                <div id="data-tag-area-propuesta" data-data='{{$propuesta->area_id}}'></div>
                            ...
                            <div class="form-group">
                                ...
                                <div id="data-tag-empresa-propuesta" data-data='{{$propuesta->empresa_id}}'></div>
                            ...
                            <div class="form-group">
                                ...
                                @if ($propuesta->get_contacto(1) != null)
                                    <div id="data-tag-contacto-empresa-propuesta" data-data='{{$propuesta->get_contacto(1)->id}}'></div>
                                @else
                                    <div id="data-tag-contacto-empresa-propuesta" data-data=''></div>
                                @endif
                                <label for="select-beast-contacto-empresa" class="form-label">Contacto Venta Empresa*</label>
                            ...
                            <div class="form-group">
                                ...
                                <div id="data-tag-contacto-otic-propuesta" data-data='{{$propuesta->contacto_otic_id}}'></div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12">
                            <div class="form-group">
                                ...
                                <div id="data-tag-programa-propuesta" data-data='{{$propuesta->programa_id}}'></div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12">
                            <div class="form-group">
                                ...
                                <div id="data-tag-curso-propuesta" data-data='{{$propuesta->curso_id}}'></div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div id="data-tag-urgencia-propuesta" data-data='{{$propuesta->urgencia_id}}'></div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="data-tag-complejidad-propuesta" data-data='{{$propuesta->complejidad_grupo_id}}'></div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <label class="custom-control custom-checkbox custom-control-inline">
                                @if ($propuesta->experiencia_ads == 1)
                                    <input id="experiencia-ads-si" onclick="experienciaAdsSi()" type="checkbox" class="custom-control-input" value="1" checked>
                                @else
                            ...
                            <label class="custom-control custom-checkbox custom-control-inline">
                                @if ($propuesta->experiencia_ads == 0)
                                    @if ($propuesta->experiencia_ads !== null)
                                        <input id="experiencia-ads-no" onclick="experienciaAdsNo()" type="checkbox" class="custom-control-input" value="1" checked>
                                    @else
                        ...
                        <input id="experiencia-ads-text" type="text" class="form-control" value="{{$propuesta->experiencia_en}}" placeholder="¿Qué experiencia?" maxlength="191" readonly>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            <label class="custom-control custom-checkbox custom-control-inline">
                                @if ($propuesta->experiencia_tematica == 1)
                                    <input id="experiencia-tematica-si" onclick="experienciaTematicaSi()" type="checkbox" class="custom-control-input" value="1" checked>
                                @else
                            ...
                            <label class="custom-control custom-checkbox custom-control-inline">
                                @if ($propuesta->experiencia_tematica == 0)
                                    @if ($propuesta->experiencia_tematica !== null)
                                        <input id="experiencia-tematica-no" onclick="experienciaTematicaNo()" type="checkbox" class="custom-control-input" value="1" checked>
                                    @else
                    ...
                    <div class="form-group">
                        ...
                        <div id="data-tag-perfil-propuesta" data-data='{{json_encode($propuesta->participante_perfil_ids())}}'></div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="data-tag-foco-propuesta" data-data='{{json_encode($propuesta->foco_intervencion_ids())}}'></div>
                    ...
                    <div class="form-group">
                        <input id="foco-observacion" type="text" class="form-control" value="{{$propuesta->observacion_foco}}" placeholder="Indique el foco de intervención" maxlength="191" hidden>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8 col-sm-12">
                    <div class="form-group">
                        ...
                        @foreach ($propuesta->documentos_propuesta() as $file)
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a class="btn btn-cyan btn-sm" href="descargar_archivo/{{$file->hash_file_name}}/{{$file->file_name}}" title="Descargar"><i class="fas fa-file-download"></i></a>
                        ...
                        <div class="custom-file">
                            ...
                            <div id="custom-file-propuesta-alert" class="invalid-feedback">Se debe seleccionar un formato valido. Solo se puede subir hasta 20 archivos.</div>
                        </div>
                        <div id="archivos"></div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <textarea id="observaciones" class="form-control" name="observaciones" rows="6" maxlength="9999">{{$propuesta->observaciones}}</textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="card-footer row">
            <div class="col-md-6 col-sm-6">
                <a href="/propuesta/show/{{ $propuesta->id }}" class="btn btn-secondary">Cancelar</a>
            </div>
            <div class="col-md-6 col-sm-6 text-right">
                <button type="button" onclick="enviarDatos({{$propuesta->id}});" id="button-crear" class="btn btn-primary">Guardar Cambios</button>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="/js/propuesta/edit.js"></script>
@endsection