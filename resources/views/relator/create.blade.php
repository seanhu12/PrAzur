...
@section('titulo', 'Crear Relator')
    @section('contenido')

        <div class="card  col-lg-8 col-md-12 mx-auto">
            <div class="card-header">
                <h3 class="card-title">Crear Relator</h3>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="apellido" onchange="validarNombre(document.getElementById('apellido').value,'apellido');" type="text" class="form-control" name="apellido" placeholder="Apellido" maxlength="191"  >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="vigencia_sence" onchange="validarFechaNoPasada(document.getElementById('vigencia_sence').value,'vigencia_sence');" type="date" class="form-control" name="vigencia_sence" placeholder="Fecha" maxlength="191" >
            ...
            <div class="card-footer row">
                <div class="col-md-6 col-sm-12">
                    <a href="/relator" class="btn btn-secondary">Cancelar</a>
                </div>
                <div class="col-md-6 col-sm-12 text-right">
                        <button type="button" onclick="enviarDatos();" id="button-crear" class="btn btn-primary" >Crear Relator</button>
                </div>
            </div>
        </div>
    ...
    @section('scripts')
        ...
        <script src="/js/relator/create.js"></script>
    @endsection
