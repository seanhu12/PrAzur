...
@section('titulo', 'Crear Contacto Empresa')
    @section('contenido')

        <div class="card  col-lg-8 col-md-12 mx-auto">
            <div class="card-header">
                <h3 class="card-title">Crear Contacto de Empresa</h3>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="area" type="text" class="form-control" name="area" placeholder="Área" maxlength="191" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="cargo" type="text" class="form-control" name="cargo" placeholder="Cargo" maxlength="191" >
                ...
                <div class="card-footer row">
                    <div class="col-md-6 col-sm-12">
                        <a href="/contacto_empresa" class="btn btn-secondary">Cancelar</a>
                    </div>
                    <div class="col-md-6 col-sm-12 text-right">
                        <button type="button" onclick="enviarDatos();" id="button-crear" class="btn btn-primary" >Crear Contacto Empresa</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    @section('scripts')
        ...
        <script src="/js/contacto_empresa/create.js"></script>
    @endsection
